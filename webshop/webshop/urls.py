...
urlpatterns = [
    ...
    path('profile/history', views.Homepage.show_order_history, name='history'),
    ...
    path('details/<slug:pk>/add_to_cart',
         views.Article.add_to_cart, name='add_to_cart'),
    ...
    path('order/payment', views.Order_Views.show_payment_info, name='payment_view'),
    path('order/<slug:pk>/checkout', views.Order_Views.checkout, name='checkout'),
    ...
    path('cart/<slug:pk>/increase',
         views.Cart_View.increase_cart_amount, name='increase'),
    path('cart/<slug:pk>/decrease',
         views.Cart_View.decrease_cart_amount, name='decrease'),
